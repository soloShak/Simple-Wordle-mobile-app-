...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //generating the secret word, which should be found
        ...
        submitBtn.setOnClickListener{
            ...
            if (dictionary.contains(guessWord)) {
                ...
                // for loop in order to find fill the 3 columns at the bottom of screen.
                // It iterates over every character in guessWord and calls the necessary adapter
                for (i in guessArray.indices){
                    if (guessArray[i] == secretWordArray[i]) {
                        if (!greenArrayList.contains(guessArray[i].toString())) {
                            ...
                            // if the given letter is in yellow column, then delete it from there
                ...
                // to fill the words list and make it point to the bottom of list
